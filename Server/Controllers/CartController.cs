...
namespace BlazorEcommerce.Server.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ServiceResponse<List<CartProductResponseDto>>>> StoreCarItems(List<CartItem> cartItems)
        {
            var result = await _cartService.StoreCarItems(cartItems);
            return Ok(result);
        }
